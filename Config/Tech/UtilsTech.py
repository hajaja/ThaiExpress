...
def generateIndicator(dictDataSpec):
    if dictDataSpec['strModelName'] in ['SVM', 'DecisionTreeClassifier', 'LogisticRegression', 'MultinomialNB', 'MultinomialNBSymbol', 'GaussianHMM', 'GaussianPHMM', 'RandomForestClassifier']:
